    ...
    return (
      <div>
        <div className='subnav'>
          {/* tldr: All the <Switch><Route> for the base app.js will be located in route.js */}
        ...
        <div className='box'>
          {/* This is the <Switch><Route> shit for all the components of the About component */}
          <Switch>
            <Route component={History} path='/about/history'/>
            <Route component={Contact} path='/about/contact'/>
            {/* renders JSX instead of a component if the path matches 
            REMEMBER THAT WHEN USING AN ARROW FUNCTION, WE EXPECT A RETURN VALUE.*/}
            <Route render={ () => (
              <div id ="About">
